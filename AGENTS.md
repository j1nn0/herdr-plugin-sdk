...
- Use English for all non-user-facing communication and generated artifacts.
- Use English for agent-to-agent communication, code, comments, documentation, commit messages, plans, and intermediate reports.
